...
def buscar_airbnb(busca):
    ...
    try:
            ...
            try:
                ...
                if href:
                    ...
                    if clean_id:
                        ...
                        link = f"https://www.airbnb.com.br/rooms/{room_id}?checkin={busca['checkin']}&checkout={busca['checkout']}&adults={busca['adultos']}"
                    else:
                        link = href
            except:
                pass
        ...
        if precos_todos:
            ...
            resultado["destaques"]       = destaques_unicos[:12]
